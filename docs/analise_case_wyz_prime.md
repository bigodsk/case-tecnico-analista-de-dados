...
- **Perfil primário:** Adultos de 35–55 anos, classe média, Members do programa de fidelidade
...
Análise combinada de ticket médio, margem de lucro e volume de vendas:
...
- Taxa de reativação de e-commerce B2C no varejo varia de **15% a 25%** segundo estudos do setor (Klaviyo, Salesforce)
...
Com margem de 15% e ticket de $1.035, o ROI de campanhas pagas é viável. Meta 2026: crescer Sports and Travel de $130K para $160K em 2025 representaria +23%.
